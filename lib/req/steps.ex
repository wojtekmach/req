defmodule Req.Steps do
  ...
  """
  @doc step: :request
  defdelegate compressed(request), to: Req.Decompress
  ...
  """
  @doc step: :request
  defdelegate checksum(request), to: Req.Checksum
  ...
  """
  @doc step: :response
  defdelegate verify_checksum(request_response), to: Req.Checksum
  ...
  """
  @doc step: :response
  defdelegate decompress_body(request_response), to: Req.Decompress
  ...
  """
  @doc step: :response
  defdelegate decode_body(request_response), to: Req.Decode
  ...
  """
  @doc step: :response
  defdelegate redirect(request_response), to: Req.Redirect
  ...
  """
  @doc step: :response
  defdelegate handle_http_digest(request_response), to: Req.Auth
